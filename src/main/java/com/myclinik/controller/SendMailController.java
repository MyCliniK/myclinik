...
public class SendMailController {
    ...
    public String sendMail(@RequestParam("mail") String mail, @RequestParam("subject") String subject, @RequestParam("body") String body){ // Como parámetro llegan los inputs del formulario
