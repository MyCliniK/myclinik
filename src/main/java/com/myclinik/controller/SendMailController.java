...
public class SendMailController {
	...
	public String sendMail(@RequestParam("client") Client client, @RequestParam("subject") String subject,
			@RequestParam("body") String body) { // Como parámetro llegan los inputs del formulario
		String to = client.getEmail();
		String from = "myclinik.org@gmail.com";
		String message = body + "\n\n\n Te hemos enviado este correo informativo a " + to
				+ " porque has contratado nuestros servicios recientemente. Si no quieres recibir correos con ofertas y promociones, háznoslo saber y te daremos de baja. \n © 2022 MyClinik Org, Av. Complutense, 30, 28040 Madrid, España."; // Formato
																																																												// del
																																																												// email
