...
public class TreatmentController {
    ...
    @RequestMapping("/treatments/edit/{treatmentId}")
	public String showEditTreatment(Model model, @PathVariable(name = "treatmentId") long treatmentId) {
	...
	@RequestMapping("/treatments/delete/{treatmentId}")
	public String deleteAppointment(@PathVariable(name = "treatmentId") long treatmentId) {
